...
CREATE TABLE `archive_faqs` (
  ...
  UNIQUE KEY `index_archive_faqs_on_position` (`position`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `message_threads` (
  ...
  `all_from_self` tinyint(1) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `messages` (
  ...
  `parent_type` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_messages_on_parent_id_and_parent_type` (`parent_id`,`parent_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `potential_prompt_matches`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `questions` (
  ...
  `position` int(11) DEFAULT '1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_questions_on_archive_faq_id_and_position` (`archive_faq_id`,`position`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `unwrangled_tags`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `unwrangled_tags` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_unwrangled_tags_on_tag_id_and_tag_type` (`tag_id`,`tag_type`),
  KEY `index_unwrangled_tags_on_tag_id` (`tag_id`),
  KEY `index_unwrangled_tags_on_fandom_id_and_tag_type` (`fandom_id`,`tag_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
